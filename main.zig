...
const dumpToStdout = ui.dumpCanvas32ToStdout;
...
pub fn main() !void {
    ...
    const internalFont = ui.loadInternalFont();
    ...
    while (true) {
        ...
        ui.drawText(&canvas, internalFont, 64, 64, "The quick brown fox jumps over the lazy dog!");
        ui.drawText(&canvas, internalFont, 64, 64 + 32, "Citrus irjal endzsint!");
