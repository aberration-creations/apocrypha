    ...
    while (true) {
        ...
        for (0..14) |x| {
            for (0..8) |y| {
                ...
                var b0 = Box.initCoords(px + @as(u32, (prng.random().int(u32) +% time) % 128), py + @as(u32, prng.random().int(u32) % 128), px + @as(u32, prng.random().int(u32) % 128), py + @as(u32, prng.random().int(u32) % 128));

                var b1 = Box.initCoords(px + @as(u32, prng.random().int(u32) % 128), py + @as(u32, (prng.random().int(u32) +% time) % 128), px + @as(u32, prng.random().int(u32) % 128), py + @as(u32, prng.random().int(u32) % 128));
